Feature: Find content differences between Production and Stage FAS environments

  Scenario Outline: Content on Dev page "<selected>" should be the same as on respective Production page
    When you look at the "main" section of the "<selected>" page on "FAS" "PROD" and "STAGE"
